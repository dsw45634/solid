...
public class SquareTest extends TestCase {
    ...
    @Test
    public void shouldChangeWidthAndHeight() {
        // given
        Square square = new Square(width, height);
        // when
        square.setWidth(modified);
        // then
        Assert.assertEquals(modified, square.getWidth());
        Assert.assertEquals(modified, square.getHeight());
    }

    @Test
    public void shouldChangeHeightAndWidth() {
        // given
        Square square = new Square(width, height);
        // when
        square.setHeight(modified);
        // then
        Assert.assertEquals(modified, square.getWidth());
        Assert.assertEquals(modified, square.getHeight());
    }
